...
function buildCarousel(
  ...
  let DEG2RAD = Math.PI / 180,
    ...
    onPress = (e) => {
      ...
      lastRotation = rotation; // Store the last rotation
    ...
    onRelease = (e) => {
      ...
      if (rotation === onPressRotation) {
        ...
        // Calculate velocity based on the difference in rotation
        velocity = rotation - lastRotation;
        lastRotation = rotation;

        // Apply inertia effect
        gsap.to(self, {
          rotation: rotation + velocity * 10, // Adjust multiplier for effect strength
          duration: 0.5, // Duration for inertia effect
          ease: "power2.out",
          onComplete: () => {
            // Reset velocity after inertia completes
            velocity = 0;
          }
        });
      }
